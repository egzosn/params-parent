...
import com.egzosn.jdbc.params.Field4Column;
import com.egzosn.jdbc.params.Where;
import com.egzosn.jdbc.params.enums.Restriction;
import com.egzosn.jdbc.params.utils.SQLTools;
...
public class OdOrderDaoParams extends Where {
    ...
    public OdOrderDaoParams setOrderCreateTime(String orderCreateTime, boolean isHQL) {
        and(isHQL ? Field.orderCreateTime.name() : Field.orderCreateTime.getColumn(), orderCreateTime, alias);
        return this;
    }

    public String getOrderCreateTime() {
        return (String) attrs.get(Field.orderCreateTime.name());
    }

    public OdOrderDaoParams setOrderCreateTimeLLk(String orderCreateTime, boolean isHQL) {
        and(isHQL ? Field.orderCreateTime.name() : Field.orderCreateTime.getColumn(), orderCreateTime, Restriction.LLK, alias);
        return this;
    }

    public OdOrderDaoParams setOrderCreateTimeRLK(String orderCreateTime, boolean isHQL) {
        and(isHQL ? Field.orderCreateTime.name() : Field.orderCreateTime.getColumn(), orderCreateTime, Restriction.RLK, alias);
        return this;
    }

    public OdOrderDaoParams setOrderCreateTimeLK(String orderCreateTime, boolean isHQL) {
        and(isHQL ? Field.orderCreateTime.name() : Field.orderCreateTime.getColumn(), orderCreateTime, Restriction.LK, alias);
        return this;
    }
